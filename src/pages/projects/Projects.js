...
const Projects = () => {
  ...
  <Description>
    React, Node.js, MySQL(RDS) 기반으로 구축한 <strong>JWT 인증 기반 메모 관리 앱</strong>입니다.
    사용자는 로그인 후 자신의 메모를 등록, 삭제할 수 있으며, soft delete 로직과 RESTful API 설계를 적용했습니다.
  </Description>
  <TechIcons>
    <FaReact title="React" />
    <FaNodeJs title="Node.js" />
    <SiMysql title="MySQL (RDS)" />
    <FaDatabase title="Database" />
  </TechIcons>
</ProjectCard>
</Container>
